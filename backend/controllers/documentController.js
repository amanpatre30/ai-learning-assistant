 ...
 * @access Private
 */
// console.log("Loaded document controller");
...
/**
 * @desc Get single document witht chunks
 * @routes GET /api/document/:id
 * @access Private
 */
export const getDocument = async (req, res, next) => {
  console.log("Inside getDcoument");
  try {
    console.log("Dcoument ID :", req.params.id);
    ...
    //Get count of asscociated flashcards and quizzess
